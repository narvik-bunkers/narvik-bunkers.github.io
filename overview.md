...
The project is ongoing and the map is incomplete: there are sites I have not visited yet (e.g., Korshamn, Porsøya, Ramnesodden, Tjeldodden, Elvegårdsmoen) or found (e.g. on Ankenesfjellet and Øyjord), and I have probably missed interesting installations near some that are on the map. Also, Saltvikneset has much more to offer than shown on the map currently.
...
In addition to that, I have the feeling that the [bunker at Framneslia](/?pos=RXP) is Norwegian (apparently the one [photographed here](https://digitaltmuseum.no/021017791639/bunkers-i-framneslia-i-narvik)) as is the little [single-room shelter next to it](/?pos=GWY), the [Arbeiderveien pillbox](/?pos=QNW), and the somewhat hidden [bunker at Jaklamyra](/?pos=MBZ). Candidates for Norwegian post-war construction are the [tunnel in Lodve Langesgt.](/?pos=NXG) and the two small [Malmveien bunkers](/?pos=JCC-ZLR). On Øyjord I would assume that the [installation at Langstrand/Øyjordtangen](/?pos=VRZ-HKV-YSK-NZX-CKM) is a Norwegian construction built prior to the German invasion.
