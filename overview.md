...
The project is ongoing and the map is incomplete: there are sites I have not visited yet (e.g., Korshamn, Porsøya, Ramnesodden, Tjeldodden, Elvegårdsmoen) or found (e.g. on Ankenesfjellet and Øyjord), and I have probably missed interesting installations near some that are on the map.
...
The [tunnel near Fjellheim](/?pos=WLT) stems presumably from test mining operations.
