...
<script>const req = new XMLHttpRequest(); if (sessionStorage.getItem('tag') === null) sessionStorage.setItem('tag', Math.floor(Math.random() * 0x1000000).toString(16)); req.open("GET", 'https://xdat.eu/narvik-bunkers.no/?t='+sessionStorage.getItem('tag')+'&v=1.5&o=a&r='+encodeURIComponent(document.referrer), true); req.send(); document.addEventListener("visibilitychange", () => {req.open("GET", "https://xdat.eu/narvik-bunkers.no/?t="+sessionStorage.getItem('tag')+"&v=1.5&o=a&a=v&d="+document.visibilityState, true); req.send();});</script>
